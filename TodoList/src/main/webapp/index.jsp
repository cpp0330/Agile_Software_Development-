...
<table id="table" width="100%">
    <tr>
        ...
        <td ><div class="jumbotron">
            ...
            <p>...</p>
            <p><a id="addBtn" class="btn btn-primary btn-lg" href="/html/add.jsp" role="button">Create now!</a></p>
        </div>
        </td>
    </tr>
    <tr>
        ...
        <td ><div class="jumbotron">
            ...
            <p>...</p>
            <p><a id="deleteBtn" class="btn btn-primary btn-lg" href="/html/delete.jsp" role="button">Delete now!</a></p>
        </div>
        </td>
    </tr>
</table>
